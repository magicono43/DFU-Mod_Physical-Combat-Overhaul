...
// Author:          Kirk.O
// Version:			v.2.00
// Created On: 	    8/29/2022, 9:00 AM
// Last Edit:		8/29/2022, 9:00 AM
// Modifier:
// Special Thanks:  Interkarma, Hazelnut, Kab the Bird Ranger, Ralzar, ACNAero, Jehuty, BadLuckBurt, DunnyOfPenwick
...
{
    public class PhysicalCombatOverhaulMain : MonoBehaviour, IHasModSaveData
    {
        static PhysicalCombatOverhaulMain instance;

        public static PhysicalCombatOverhaulMain Instance
        {
            get { return instance ?? (instance = FindObjectOfType<PhysicalCombatOverhaulMain>()); }
        }
        ...
        {
            mod = initParams.Mod;
            instance = new GameObject("PhysicalCombatOverhaul").AddComponent<PhysicalCombatOverhaulMain>(); // Add script to the scene.
        ...
        private void Start()
        {
            ...
            Debug.Log("PhysicalCombatOverhaul Registered Override For DaggerfallCharacterSheetWindow");
        ...
        {
            get { return typeof(PhysicalCombatOverhaulSaveData); }
        }

        public object NewSaveData()
        {
            return new PhysicalCombatOverhaulSaveData
            {
        ...
        {
            var PhysicalCombatOverhaulSaveData = (PhysicalCombatOverhaulSaveData)saveData;
            notifiedSkillsList = PhysicalCombatOverhaulSaveData.NotifiedSkillsList;
        }
    }

    [FullSerializer.fsObject("v1")]
    public class PhysicalCombatOverhaulSaveData
    {
